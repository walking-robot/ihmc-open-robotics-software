...
public class GraspingFingerPaneController
{
   ...
   public void initialize(JavaFXMessager messager)
   {
      ...
      messager.bindPropertyToTopic(GraspingJavaFXTopics.LeftSendMessage, btnSendLeftFingerMessage.defaultButtonProperty());
      messager.bindPropertyToTopic(GraspingJavaFXTopics.RightSendMessage, btnSendRightFingerMessage.defaultButtonProperty());
   }
